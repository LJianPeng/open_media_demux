...
public:
    ...
    QLabel *FrameShowBinaryTextLabel_2;
    QLabel *MediaInfoLable;
    QTextEdit *FrameShowBinaryText;
    QRadioButton *RawStreamDisplay;
    QTextEdit *MediaInfo;
    QMenuBar *menuBar;
    QMenu *menu;
    QMenu *menuview;
    ...
    void setupUi(QMainWindow *SPasClass)
    {
        ...
        FrameListTableWidget->setMinimumSize(QSize(0, 460));
        ...
        gridLayout->addWidget(FrameListTableWidget, 0, 0, 1, 3);
        ...
        FrameShowBinaryTextLabel_2 = new QLabel(groupBox);
        FrameShowBinaryTextLabel_2->setObjectName(QStringLiteral("FrameShowBinaryTextLabel_2"));

        gridLayout->addWidget(FrameShowBinaryTextLabel_2, 1, 1, 1, 1);

        MediaInfoLable = new QLabel(groupBox);
        MediaInfoLable->setObjectName(QStringLiteral("MediaInfoLable"));

        gridLayout->addWidget(MediaInfoLable, 1, 2, 1, 1);

        FrameShowBinaryText = new QTextEdit(groupBox);
        FrameShowBinaryText->setObjectName(QStringLiteral("FrameShowBinaryText"));
        FrameShowBinaryText->setMinimumSize(QSize(700, 200));

        gridLayout->addWidget(FrameShowBinaryText, 2, 0, 1, 1);

        RawStreamDisplay = new QRadioButton(groupBox);
        RawStreamDisplay->setObjectName(QStringLiteral("RawStreamDisplay"));

        gridLayout->addWidget(RawStreamDisplay, 2, 1, 1, 1);

        MediaInfo = new QTextEdit(groupBox);
        MediaInfo->setObjectName(QStringLiteral("MediaInfo"));
        MediaInfo->setMinimumSize(QSize(160, 200));

        gridLayout->addWidget(MediaInfo, 2, 2, 1, 1);
    ...
    void retranslateUi(QMainWindow *SPasClass)
    {
        ...
        FrameShowBinaryTextLabel_2->setText(QApplication::translate("SPasClass", "Button Group", Q_NULLPTR));
        MediaInfoLable->setText(QApplication::translate("SPasClass", "Media Info", Q_NULLPTR));
        RawStreamDisplay->setText(QApplication::translate("SPasClass", "\346\230\276\347\244\272\350\243\270\347\240\201\346\265\201", Q_NULLPTR));
